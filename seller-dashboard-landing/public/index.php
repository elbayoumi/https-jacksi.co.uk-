...
<body class="bg-gray-100 text-gray-800">
    ...
    <header class="bg-blue-600 text-white py-20">
        <div class="container mx-auto text-center">
            <h1 class="text-4xl md:text-6xl font-bold">Empower Your Selling Experience</h1>
            <p class="mt-4 text-lg md:text-xl">A powerful SaaS platform for sellers and admins to manage their business effortlessly.</p>
    ...
    <section class="py-20">
        <div class="container mx-auto text-center">
            <h2 class="text-3xl md:text-5xl font-bold">Features</h2>
    ...
    <section class="bg-gray-200 py-20">
        <div class="container mx-auto text-center">
            <h2 class="text-3xl md:text-5xl font-bold">Our Tech Stack</h2>
    ...
    <section id="cta" class="py-20">
        <div class="container mx-auto text-center">
            <h2 class="text-3xl md:text-5xl font-bold">Ready to Get Started?</h2>
